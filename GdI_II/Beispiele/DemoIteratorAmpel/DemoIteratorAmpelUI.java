public class DemoIteratorAmpelUI
{
  public static void main (String args[])
  {
      ...
      while (eineAmpel.hasNext() )
      {
          ...
          {
             case 0: System.out.println("Ampel = rot"); break;
             case 1: System.out.println("Ampel = gelb"); break;
             case 2: System.out.println("Ampel = gruen"); break;
             case 3: System.out.println
                             ("Ampel = außer Betrieb"); break;
