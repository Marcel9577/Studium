...
class AufgabenplanerUI
{
 ...
 { 
  ...
  for(;;)
  {
    ...
    {  
      case '1': AufgabenplanerUI.erfasseAufgabe(); break;
      case '2': AufgabenplanerUI.anzeigeAufgabeStichwort(); break;
      case '3': AufgabenplanerUI.anzeigeAufgabenSortiert(); break;
      case '4': AufgabenplanerUI.erfassePerson(); break;
      case '5': AufgabenplanerUI.anzeigePersonen(); break;
      case '6': AufgabenplanerUI.zuordnePersonZuAufgabe(); break;
      case '7': AufgabenplanerUI.zuordneMitarbeiterZuAufgabe(); break;
      case '8': AufgabenplanerUI.bearbeiteAufgabePersonMitarbeiter(); break;
      default: System.out.println("Fehlerhafte Eingabe: Bitte nur 1 bis 8 eingeben"); 
    } 
  }
 ...
 private static void erfasseAufgabe()
 {
    ...
    for(;;)
    {
        ...
        if(meinContainer.gibAufgabe(stichwort)==null) break;
        else System.out.println("Stichwort bereits belegt");
    }
    String beschreibung = erfasseText("Beschreibung", true);
    LocalDate fertigAm = erfasseDatum("Geplantes Ende tt.mm.jjjj", true, true);
    if(fertigAm!=null)System.out.println("Gelesenes Datum:" + meinKurzformat.format(fertigAm));
    ...
    Iterator e = meinContainer.iteratorKontaktpersonen();
    while(e.hasNext())
    {
  ...
  private static void anzeigeAufgabenSortiert()
  {
    ...
    while(e.hasNext()) druckeAufgabe(e.next());
    System.out.println(linie);
  }//Ende Funktion 3
  ...
  private static void erfassePerson()
  {
    ...
    for(;;)
    {
        ...
        if(meinContainer.gibPerson(spitzname)==null) break;
        else System.out.println("Spitzname bereits belegt");
    }
    ...
    if(eineAufgabe!=null)
    {
       ...
       for(;;)
       {
         ...
         if(bearbeiter!=null)
         {
          ...
          eineAufgabe.hinzufuegenTeilaufgabe(teilaufgabe);
         }
        if(erfasseCharacter("Noch ein Bearbeiter j/n", true, new char[]{'j','n'}) == 'n') break;  
      }
    }
 } //Ende Funktion 7
  ...
  private static Aufgabe ermittleAufgabe()
  {
    ...
    if(ergebnis==null) System.out.println("Aufgabe nicht vorhanden");
    return ergebnis;
  }
  ...
  private static Person ermittlePerson(boolean pflicht)
  {
    ...
    if(ergebnis==null) System.out.println("Person nicht vorhanden");
    return ergebnis;
  }
  ...
  private static Mitarbeiter ermittleMitarbeiter()
  {
    ...
    if(ergebnis==null) System.out.println("Mitarbeiter nicht vorhanden");
    return ergebnis;
  }
