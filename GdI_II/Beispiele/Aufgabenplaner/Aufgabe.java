...
{ 
  ...
  Status status, Person kontaktperson)
 {
     ...
     if(prioritaet!=null) this.prioritaet = prioritaet; //Kein Pflichtfeld
     if(kategorie!=null) this.kategorie = kategorie; //Kein Pflichtfeld
     if(kategorie!=null) this.status = status; //Kein Pflichtfeld
 ...
 public LocalDate getFertigAm(){ return fertigAm; }
 public Prioritaet getPrioritaet(){ return prioritaet; }
 public LocalDate getErfasstAm(){ return erfasstAm; }
 public Kategorie getKategorie(){ return kategorie; }
 public Status getStatus(){ return status; }
 public Person getKontaktperson(){ return kontaktperson; }
 
 //Setter
 public void setStichwort(String stichwort){ this.stichwort = stichwort; }
 public void setBeschreibung(String beschreibung){ this.beschreibung = beschreibung; }
 public void setFertigAm(LocalDate fertigAm){ this.fertigAm = fertigAm; }
 ...
 public void setKontaktperson(Person einePerson){ kontaktperson = einePerson; }

 //Teilaufgaben
 public void hinzufuegenTeilaufgabe(Taetigkeit teilaufgabe){ this.teilaufgaben.add(teilaufgabe); }
 public void loeschenTeilaufgabe(Taetigkeit teilaufgabe){ this.teilaufgaben.remove(teilaufgabe); }
 public Iterator<Taetigkeit> iteratorTeilaufgaben(){ return this.teilaufgaben.iterator(); }
}
