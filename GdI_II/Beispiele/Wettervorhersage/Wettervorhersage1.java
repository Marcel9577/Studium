public class Wettervorhersage1
{
    //Klassenattribute
    ...
    public Wettervorhersage1(String ort)
    {
        this.ort = ort;
         //14-Tage-Trend
       ...
       (int minTemp, int maxTemp, int niederschlag, int luft, int wind)
    {
        ...
        //Alle bisherigen Vorhersagen (ausser erste Vorhersage) kopieren
        for(int i=1; i<vorhersage.length; i++)
        {
            vorhersage[i-1]=vorhersage[i];
        }
        //Neue Vorhersage ans Ende
        vorhersage[vorhersage.length-1] = vorhersageTag;   
