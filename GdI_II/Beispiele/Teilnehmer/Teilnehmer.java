...
{
   public static void findeTeilnehmerImperativ
      (ArrayList<String> teilnehmerliste) 
   {
    ...
    System.out.println("Mustermann hat teilgenommen? " 
      + teilgenommen);
  }

  public static void findTeilnehmerDeklarativ
      (ArrayList<String> teilnehmerliste) 
  {
    System.out.println("Mustermann hat teilgenommen? " 
      + teilnehmerliste.contains("Mustermann"));
  }
