...
{ 
 public static <E extends Comparable<E>> 
   void sortieren(ArrayList<E> liste)
 {
    int i, j;
    E merke;
    ...
    {  //Element herausgreifen
     ...
     for (j = i-1; j >= 0 
       && merke.compareTo(liste.get(j)) < 0; j--)
 ...
 { 
  ...
  ArrayList<String> eineStringListe = 
     new ArrayList<>();
  ...
  ArrayList<Integer> eineIntegerListe = 
    new ArrayList<>();
  eineIntegerListe.add(10); eineIntegerListe.add(50);
  eineIntegerListe.add(30); eineIntegerListe.add(1);
  ...
  ArrayList<Freund> eineFreundListe = 
     new ArrayList<>();
