...
{ 
 ...
 { 
  ...
  System.out.println
   ("--- Sortierkriterium Vorname ---");
  Collections.sort
   (eineListe, Freund.vornameComparator);
  for (Freund element : eineListe)
      System.out.println(element.getVorname() + " " 
      + ((Freund) element).getNachname() + " "
      + ((Freund) element).getAlter());    
  
  System.out.println
   ("--- Sortierkriterium Alter ---");
  Collections.sort
   (eineListe, Freund.alterComparator);
  for (Freund element : eineListe)
      System.out.println(element.getAlter() + " " 
      + element.getNachname() + " "
      + element.getVorname());    
 } 
}
