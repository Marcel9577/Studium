...
class InserentenverwaltungUI
{
  ...
  private static void druckeAnzeige(Anzeige eineAnzeige)
 {
     ...
     System.out.println("Inserent: " + 
        eineAnzeige.getLinkKunde().getName());
 }
 //-----------------------------------------------
 public static void main (String args[]) 
 { 
  ObjektContainer meinContainer = 
             ObjektContainer.getObjektreferenz();
  Kunde einKunde;
  Anzeige eineAnzeige;
  char auswahl; 
  for(;;)
  {
    ...
    {  
      case '1': 
      {
          ...
          einKunde = new Kunde(
            kundennr,name,telefon,blz,kontonr);
      ...
      case '2': 
      {
          ...
          for (Object o : anzeigen)
          {
           ...
           System.out.println(eineAnzeige.getAnzeigennr() +
