public class AuftragUI
{
 ...
 {
   //Attribute
   Auftrag einAuftrag, identischerAuftrag, 
    nocheinAuftrag;
   ...
   System.out.println
    ("einAuftrag ist identisch mit identischerAuftrag: "  
     + (einAuftrag == identischerAuftrag));
   
   System.out.println
    ("einAuftrag ist identisch mit nocheinAuftrag: "  
     + (einAuftrag == nocheinAuftrag));
     
    System.out.println
    ("einAuftrag ist inhaltlich gleich mit nocheinAuftrag: "  
