...
public class DemoInstantDuration
{
  public static void main(String[] args)
  {
   ...
   zeitpunktplus = zeitpunktaktuell.plus
      (Duration.ofHours(10).plusMinutes(5));
   System.out.println
     ("Zeitpunkt + 10 h + 5 min: " + zeitpunktplus);

   zeitpunktminus = zeitpunktaktuell.minus(Duration.ofDays(5));
   System.out.println("Zeitpunkt - 5 Tage: " + zeitpunktminus);

   System.out.println("ZeitpunktPlus vor Zeitpunktaktuell? " 
    + zeitpunktplus.isAfter(zeitpunktaktuell));

   System.out.println("ZeitpunktMinus nach Zeitpunktaktuell? "
    + zeitpunktplus.isBefore(zeitpunktaktuell));
  }
}