...
public class Teilnehmer2
{
  public static void main(String[] args) 
  {
    ...
    System.out.println(
       "(2) Teilnehmerliste mit erweiterter for-Schleife");
   ...
   System.out.println(
      "(3) Teilnehmerliste mit forEach aus Java 8");
    ...
    System.out.println(
      "(4) Lambda-Ausdruck ersetzt innere Klasse");
    teilnehmerliste.forEach
    ...
    System.out.println(
     "(6) Lambda-Ausdruck mit einem Parameter");
    //Klammer um Parameter kann entfallen
    teilnehmerliste.forEach(
       name -> System.out.println(name) );
    
    System.out.println(
      "(7) Rumpf ersetzt durch Methodenreferenz");
