...
public class DemoLocalDate2
{
 public static void main (String args[]) 
 {
   ...
   DateTimeFormatter meinEingabeFormat = 
   ...
   System.out.println("Ihr Geburtsdatum: " 
     + geburtsDatum.format(meinAusgabeFormat));
   ...
   else
   {
     System.out.println("Ihr Alter: " 
       + geburtsDatum.until(aktuellesDatum).getYears());
   }
 }
}